...
class PPOAgent:
    ...
    def __init__(self, env, lr=3e-4, gamma=0.99, gae_lambda=0.98, value_coeff=0.5,
    ...
    def update(self, rollouts):
        """
        Performs a PPO update step. This involves multiple epochs of
        iterating over the collected data in minibatches.
        """
        # Unpack rollouts
        states = rollouts['states']
        actions = rollouts['actions']
        ...
        for update in range(num_updates):
            ...
            if update % 10 == 0:
                ...
                print(f"Update {update}, Timesteps: {self.total_timesteps}, Episodes: {len(self.episode_returns)}, "
                      f"Avg Return: {avg_return:.2f}, Entropy Coeff: {self.ent_coef:.4e}, "
